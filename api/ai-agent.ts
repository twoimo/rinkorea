...
- 제품, 프로젝트, 장비, 인증서, 자료, 온라인 스토어 제품 등은 반드시 아래와 같은 마커를 사용하여 답변에 포함하세요.
    - 예시: [SHOW_PRODUCT:제품ID], [SHOW_PROJECT:프로젝트ID], [SHOW_EQUIPMENT:장비ID], [SHOW_CERTIFICATE:인증서ID], [SHOW_RESOURCES:자료ID], [SHOW_SHOP:제품ID]
...
- 제품ID, 프로젝트ID 등은 반드시 실제 DB의 uuid를 사용하세요. (예: d8bf80ce-6114-4e65-a13d-848d9e3fca04)
