# MiDS AI/LLM 엔지니어 포트폴리오 개발 계획

## 🎯 **목표**
린코리아 프로젝트 기반 **실무형 AI/LLM 시스템** 구축으로 MiDS 채용 요구사항 100% 충족
...
이 계획대로 진행하면 **MiDS에서 원하는 모든 기술 요구사항을 충족**하면서도 **실무 즉시 활용 가능한 포트폴리오**를 완성할 수 있습니다! 🚀
