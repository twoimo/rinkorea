                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-8 md:mb-12">
                        ...
                        <p className="text-lg md:text-xl text-gray-600">
                            {category === 'premium' && '최첨단 기술이 적용된 프리미엄 연삭기 라인업'}
                            {category === 'professional' && '전문가를 위한 고성능 연삭기 시리즈'}
                            {category === 'diatool' && '고품질 다이아몬드 공구 및 액세서리'}
                        </p>
                    </div>
                        ...
                        {categoryEquipment.map((item, index) => (
                            <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                                ...
                                <div className="p-4 md:p-6">
                                    <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">{item.name}</h3>
    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
                        <div className="w-full md:w-1/2">
                            ...
                            <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                                ...
                                세계적인 공사 현장에서 사용되는 콘크리트 연삭기 시장의 선두주자입니다.
                                <br /><br />
            ...
            {activeTab === 'construction' && (
                <>
                    {renderEquipmentGrid('premium', '최신형 콘크리트 연삭기')}
                    {renderEquipmentGrid('professional', '콘크리트 연삭기', 'bg-gray-50')}
                </>
            )}

            {activeTab === 'diatool' && (
                <>
                    {renderEquipmentGrid('diatool', '다이아툴')}
                ...
                <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-lg max-h-[90vh] overflow-y-auto relative">
                        <div className="sticky top-0 bg-white border-b border-gray-200 p-4 md:p-6">
                            ...
                            <h2 className="text-xl md:text-2xl font-bold pr-8">{editingEquipment ? '기계 수정' : '기계 추가'}</h2>
                        </div>
                        <div className="p-4 md:p-6">
