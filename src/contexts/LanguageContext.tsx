...
const translations = {
    ko: {
        ...
        replies_loading: '답변 불러오는 중...',
        try_again: '다시 시도',
        no_replies_yet: '아직 답변이 없습니다.',
        write_reply: '답변 작성',
        reply_placeholder: '답변을 입력하세요...',
        post_reply: '답변 등록',
        additional_reply: '추가 답변 작성',
        reply_load_failed: '답변을 불러오는데 실패했습니다.',
        reply_create_failed: '답변 등록에 실패했습니다.',
        ...
        auth_login_subtitle: '린코리아 서비스를 이용하시려면 로그인해주세요',
        auth_signup_subtitle: '린코리아 서비스를 이용하시려면 회원가입해주세요',
        auth_name_label: '이름',
        auth_email_label: '이메일',
        auth_password_label: '비밀번호',
        auth_password_show: '비밀번호 표시',
        auth_password_hide: '비밀번호 숨기기',
        auth_password_min_length: '비밀번호는 최소 6자 이상이어야 합니다.',
        auth_login_button: '로그인',
        auth_signup_button: '회원가입',
        auth_processing: '처리 중...',
        auth_switch_to_signup: '계정이 없으신가요? 회원가입',
        auth_switch_to_login: '이미 계정이 있으신가요? 로그인',
        auth_login_failed: '로그인 실패',
        auth_signup_failed: '회원가입 실패',
        auth_login_success: '로그인 성공',
        auth_signup_success: '회원가입 완료',
        auth_invalid_credentials: '이메일 또는 비밀번호가 올바르지 않습니다.',
        auth_email_not_confirmed: '이메일 확인이 필요합니다. 이메일을 확인해주세요.',
        auth_user_exists: '이미 가입된 이메일입니다.',
        auth_confirm_email: '이메일을 확인하여 계정을 활성화해주세요.',
        auth_welcome: '환영합니다!',
        auth_error_occurred: '오류 발생',
        auth_try_again: '다시 시도해주세요.',
    ...
    en: {
        ...
        download_count_suffix: ' downloads',
        hidden: 'Hidden',
        ...
        qna_form_is_private_desc: 'Check this if you want only admin and author to see.',
        ...
        additional_reply: 'Write Additional Reply',
        reply_load_failed: 'Failed to load replies.',
        ...
        auth_login_subtitle: 'Please login to use RIN Korea services',
        auth_signup_subtitle: 'Please sign up to use RIN Korea services',
        ...
        auth_signup_success: 'Sign Up Complete',
        auth_invalid_credentials: 'Email or password is incorrect.',
        auth_email_not_confirmed: 'Email confirmation required. Please check your email.',
        auth_user_exists: 'This email is already registered.',
        auth_confirm_email: 'Please verify your email to activate your account.',
        auth_welcome: 'Welcome!',
        auth_error_occurred: 'An error occurred',
        auth_try_again: 'Please try again.',
    ...
    zh: {
        ...
        qna_load_more: '加载更多',
        qna_loading: '加载中...',
        total_inquiries: '全部咨询',
        admin_reply: '管理员回复',
        copy: '复制',
        no_search_results: '未找到搜索结果',
        try_different_search: '请尝试不同的搜索词或筛选条件',
        leave_first_inquiry: '请留下您的第一个咨询',
        ...
        post_reply: '发布回复',
        additional_reply: '撰写附加回复',
        reply_load_failed: '加载回复失败。',
        reply_create_failed: '创建回复失败。',
        reply_update_failed: '更新回复失败。',
